...
public class ReadsPipelineSpark extends GATKSparkTool {
    ...
    protected void runTool(final JavaSparkContext ctx) {
        ...
        HaplotypeCallerSpark.callVariantsWithHaplotypeCallerAndWriteOutput(ctx, filteredReadsForHC, readsHeader, sequenceDictionary, referenceArguments.getReferenceFileName(), intervalShards, hcArgs, shardingArgs, assemblyRegionArgs, output, makeVariantAnnotations(), strict, createOutputVariantIndex);
